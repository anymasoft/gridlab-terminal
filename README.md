...
Кнопка выше поднимает терминал прямо в браузере — окружение соберётся само, приложение запустится, GitHub предложит открыть порт 8100. Ничего ставить локально не нужно.
